    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-neutral-950/80 backdrop-blur-md border-b border-gray-200 dark:border-neutral-800">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button 
            variant="ghost" 
            className={`text-base ${location === '/' ? 'bg-black dark:bg-white text-white dark:text-black' : ''}`}
          ...
          <Button 
            variant="ghost" 
            className={`text-base ${location === '/shop' ? 'bg-black dark:bg-white text-white dark:text-black' : ''}`}
