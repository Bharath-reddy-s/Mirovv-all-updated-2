  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-neutral-950">
      <main className="container mx-auto px-4 pt-32 pb-16 text-[33px] text-center">
        ...
        >
          <h1 className="text-[22px] sm:text-[28px] md:text-6xl mb-6 text-black dark:text-white font-semibold whitespace-nowrap" data-testid="text-offers-title">See How To Lootify Us!!</h1>
        </motion.div>
